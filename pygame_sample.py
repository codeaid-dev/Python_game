...
while True:
    ...
    pg.draw.rect(screen, pg.Color('red'), (160,100,50,150), 1) #width引数を指定すると塗りつぶしあり枠線なし
    pg.draw.line(screen, pg.Color('blue'), (250,100), (300,250), 5) #線,2点の座標
    pg.draw.circle(screen, pg.Color('green'), (400,175), 75) #円,座標：中心,半径
    pg.draw.circle(screen, pg.Color('green'), (560,175), 75, 5) #width引数を指定すると塗りつぶしあり枠線なし
    pg.draw.ellipse(screen, (255,0,255), (100,270,50,150)) #楕円,座標：左上隅,横,縦
    pg.draw.ellipse(screen, (255,0,255), (160,270,50,150), 5) #width引数を指定すると塗りつぶしあり枠線なし
    pg.draw.polygon(screen, (0,255,255), [[245,270],[220,420],[270,420]]) #多角形,各点の座標リスト
    pg.draw.polygon(screen, (0,255,255), [[305,270],[280,420],[330,420]], 5) #width引数を指定すると塗りつぶしあり枠線なし
    ...
    screen.blit(text1, (100,440)) #
    screen.blit(text2, (360,440))
    screen.blit(img, (495,440))
    pg.display.update()
